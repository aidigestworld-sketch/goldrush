...
export default defineConfig({
  test: {
    include: [
      ...
      "src/orchestrator/__tests__/idResolvers.test.ts",
      "src/orchestrator/__tests__/errorFormatting.test.ts",
      "src/orchestrator/__tests__/llmFactory.test.ts",
      ...
      "src/agents/live/__tests__/stripeOriginatedAgentIds.test.ts",
      "src/agents/live/__tests__/upstreamSkipCascade.test.ts",
      "src/agents/live/__tests__/emptyCascadeStatus.test.ts",
      "src/agents/live/__tests__/tokenBudgetIntegration.test.ts",
      "src/agents/live/__tests__/expansionExperiencesEdges.test.ts",
      "src/orchestrator/__tests__/retryRun.test.ts",
      "src/orchestrator/__tests__/checkpointIdempotency.test.ts",
      "src/orchestrator/__tests__/founderRunsList.test.ts",
      "src/orchestrator/__tests__/runResultEndpoint.test.ts",
      ...
      "src/stripe/__tests__/stripe.test.ts",
    ],
